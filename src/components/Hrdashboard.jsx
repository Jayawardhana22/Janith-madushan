...
export const Hrdashboard = () => {
  ...
  return (
    <div className="hr-dashboard container-fluid">
      {/* Top Navigation */}
      <nav className="row bg-white py-3 shadow-sm">
        <div className="col-md-3 d-flex align-items-center">
          <button className="menu-icon btn" onClick={() => setSidebarOpen(!sidebarOpen)}>
            ☰
          </button>
          <h2 className="text-primary mb-0 fw-bold ms-2">Dashboard</h2>
        </div>
